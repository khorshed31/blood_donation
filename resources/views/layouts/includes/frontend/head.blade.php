<head>
    ...
    <title>@yield('title', 'Blog Site') | {{ config('app.name') }}</title>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('frontend/css/jquery.toast.css') }}" />
