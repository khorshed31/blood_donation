        ...
        <div class="col-xxl-3 col-lg-6 order-lg-1 order-xxl-2">
            ...
            <div class="card">
                <div class="card-body pb-0">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <h4 class="header-title">People you may chat</h4>
                        <div class="dropdown">
                            <div class="dropdown-menu dropdown-menu-end">
                            </div>
                        </div>
                    ...
                    <div class="inbox-widget">
                        ...
                        @php
                            ...
                            $image = $avatar->create(optional($user->created_user)->name)->setBackground($randomColor)->toBase64();
                        @endphp
                            <div class="inbox-item">
                            <div class="inbox-item-img"><img src="{{ isset(optional($user->created_user)->name) ? asset(optional($user->created_user)->name) : $image }}" class="rounded-circle" alt=""></div>
                            <p class="inbox-item-author">{{ optional($user->created_user)->name }}</p>
                            <p class="inbox-item-text">Blood Group: <b class="text-danger">{{ $user->blood_group }}</b></p>
                            <p class="inbox-item-date">
                                <a href="{{ route('admin.chats.show', optional($user->created_user)->id ) }}" class="btn btn-sm btn-outline-primary px-1 py-0" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Message"> 
                                    <i class='uil ri-chat-1-fill font-16'></i> </a>
                            </p>
                        </div>
                        @endforeach
                    ...
                    <div class="mt-2 mb-3 text-center">
                        <a href="{{ route('admin.all.users.index') }}">View More<i class='uil uil-arrow-right ms-1'></i></a>
                    </div>
