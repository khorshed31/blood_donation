...
trait FileSaver
{
    ...
    */
    ...
    public function uploadFileWithResize($file, $model, $database_field_name, $basePath, $height=300, $width=250)
    {
        if ($file) {

            try {

                $basePath = './uploads/assets/' . $basePath;
                ...
                $resize_image = \Image::make($file->getRealPath())->encode('webp', 90);
                // if ($format=='webp') {
